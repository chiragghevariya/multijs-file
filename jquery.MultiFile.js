...
if (window.jQuery)(function ($) {
        ...
        this
            ...
            .each(function () {
                ...
                if (!MultiFile.list) {
                    ...
                    MultiFile.wrapper.append('<div class="MultiFile-list" id="' + MultiFile.wrapID + '_list" style="float:left; width: 280px;"></div>');
                ...
                MultiFile.addToList = function (slave, slave_count, files) {
                    ...
                    $.each(files, function (i, file) {
                        var v = String('' || ''),
                            ...
                            p = '<input class="form-control" style=" float: right; margin-top: 10px; margin-left:3px; width: 205px !important;" type="text" name="image_title[]" maxlength="15" placeholder="Caption" />' +
                                '<div style=" margin-top:15px;"><ul class="reorder_ul reorder-photos-list" style=" float:left;padding-left: 0;"><li style="list-style: none outside none;margin-left:28px;margin-right: -78px;margin-top:5px;" class="ui-sortable-handle col-md-3"><img class="MultiFile-preview" height="245" width="245" style="' + MultiFile.previewCss + '"/> </li></ul></div>',
                            label = $(
                                (
                        ...
                        names[names.length] =
                            (
                                '<span title="' + MultiFile.STRING.selected + '">'
                    ...
                    var
                        ...
                        b = $('<a style="margin-top: 10px !important; margin-left: 42px; float: left; padding:6px 8px !important;" class="btn red-mint btn-outline sbold" href="#' + MultiFile.wrapID + '"><i class="fa fa-remove"></i> </a>')
    ...
    $.fn.MultiFile.options = { //$.extend($.fn.MultiFile, { options: {
        ...
        // previews
        preview: false,
        previewCss: 'max-height:245px; max-width:245px;',
